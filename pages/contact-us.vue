<template>
  <div class="wrapper">
    <section
      class="vh-100 d-flex justify-content-center align-items-center banner center-image position-relative"
    >
    ...
    <b-container>
      <section class="text-secondary py-5" aria-label="popup idea">
        <h2
          class="header font-10 font-md-18 text-dark font-weight-bolder"
          v-text="$t('contactUsPage.fromIdea')"
        />
    ...
    <div class="bg-dark py-3">
      <b-container>
        <h2
          class="font-10 font-md-18 text-white font-weight-bolder"
          v-text="$t('contactUsPage.coworker')"
        />
      </b-container>
    </div>
    ...
    <b-container class="py-5">
      ...
      >
        ...
        >
          <h3
            class="header p-0 m-0 font-10 font-md-18 font-weight-bolder"
            v-text="office.name"
          />
        ...
        <b-col cols="12">
          <b-row>
            <b-col
              v-for="(agent, i) in office.agents"
              :key="`${office.name}-${agent.name}-${i}`"
              cols="12"
              md="4"
            >
              <div class="agent">
                ...
                <div
                  class="st-background"
                  :style="{
                    backgroundImage: `url(${require('@/assets/img/contact-us/' +
                      office.name.replace(' ', '-') +
                      '-' +
                      (i + 1) +
                      '.png')})`,
                ...
                <div class="img-hover-holder gradient7">
                  <div class="info-hover">
                    <ul class="list-unstyled">
                      <li>
                        <small class="text-white">{{ agent.name }}</small>
                      </li>
                      <li>
                        <small class="text-white">{{ agent.title }}</small>
                      </li>
                    </ul>
                  </div>
      ...
      offices: [
        {
          ...
          agents: [
            ...
            },
            {
              ...
              tel: "+46 70 760 29 81",
              linkedIn:
                "https://www.linkedin.com/in/bertil-moskowicz-077778193/",
            },
            {
              ...
              tel: "+46 70 537 09 26",
              linkedIn:
                "https://www.linkedin.com/in/jonas-bergstr%C3%B6m-96742211/",
            },
          ],
        },
        {
          ...
          agents: [
            {
              ...
              tel: "+46 73 808 55 00",
              linkedIn:
                "https://www.linkedin.com/in/terese-nilsson-bj%C3%B6rling-54bb5050/",
            },
          ],
        },
        {
          ...
          agents: [
            {
              ...
              tel: "+46 70 755 27 75",
              linkedIn:
                "https://www.linkedin.com/in/annika-j%C3%B6nsson-59166520/",
            },
          ],
        },
        {
