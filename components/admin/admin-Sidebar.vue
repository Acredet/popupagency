        ...
        <ul id="side-menu" class="metismenu">
          ...
          <li>
            <a href="/" class="waves-effect">
              <i class="mdi mdi-view-dashboard" /><span class="badge badge-primary badge-pill float-right">2</span> <span> Dashboard </span>
            </a>
          </li>
          <li>
            <a href="calendar" class="waves-effect"><i class="mdi mdi-calendar-check" /><span> Calendar </span></a>
          </li>

          <li>
            <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-email-outline" /><span> Email <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right" /></span> </span></a>
            <ul class="submenu">
          ...
          <li>
            <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-buffer" /> <span> UI Elements <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right" /></span> </span> </a>
            <ul class="submenu">
          ...
          <li>
            <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-clipboard-outline" /><span> Forms <span class="badge badge-pill badge-success float-right">6</span> </span></a>
            <ul class="submenu">
          ...
          <li>
            <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-chart-line" /><span> Charts <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right" /></span> </span></a>
            <ul class="submenu">
          ...
          <li>
            <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted-type" /><span> Tables <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right" /></span> </span></a>
            <ul class="submenu">
          ...
          <li>
            <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-album" /> <span> Icons  <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right" /></span></span> </a>
            <ul class="submenu">
          ...
          <li>
            <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-google-maps" /><span> Maps <span class="badge badge-pill badge-danger float-right">2</span> </span></a>
            <ul class="submenu">
          ...
          <li>
            <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-account-location" /><span> Authentication <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right" /></span> </span></a>
            <ul class="submenu">
          ...
          <li>
            <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-google-pages" /><span> Extra Pages <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right" /></span> </span></a>
            <ul class="submenu">
