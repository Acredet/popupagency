exports.ListingDepedancies = {
  ...
  methods: {
    async addItem(link) {
      ...
      await this.$axios
        ...
        .then((res) => {
          this.getItems(link);
          const inputs = [
            ...document.querySelectorAll(".input-group--wrapper input"),
          ];
          const images = [
            ...document.querySelectorAll(".input-group--wrapper img"),
          ];
    ...
    async editItem(link) {
      ...
      await this.$axios
        .$patch(`/${link}/${this.editForm._id}`, this.editForm)
        .then((res) => {
          this.getItems(link);
          this.loadingState = false;
          this.editForm = {
      ...
      await this.$axios
        ...
        .then((res) => {
          ...
          this.toast = {
            ...
            variant: "success",
            visible: true,
            text: `${this.$t("category.toast.justDeleted")} ${
