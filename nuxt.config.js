  ...
  head: {
    ...
    meta: [
      ...
      },
      {
        ...
        name: "description",
        content:
          "Popup Agency är en nytänkande uthyrningskonsult som på ett roligt och otraditionellt arbetssätt möter framtidens krav inom handeln med korttidsavtal och popup butiker. Vi är matchmakern som hjälper dig från idé till popup.",
      },
    ],
    link: [
